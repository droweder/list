...
const ShoppingListScreen: React.FC<ShoppingListScreenProps> = ({ listName, items, onToggleItem, onEditItem, onAddItem }) => {
            ...
            categories.map(category => (
                <div key={category} className="bg-white dark:bg-gray-800 rounded-lg shadow-md">
                    ...
                    {groupedItems[category].map(item => (
                        <li key={item.id} onClick={() => onEditItem(item)} className="p-4 flex items-center justify-between border-b border-gray-200 dark:border-gray-700 last:border-b-0 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors">
